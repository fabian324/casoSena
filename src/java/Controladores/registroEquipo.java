 ...
 * @author fabian
 */
@WebServlet(name = "registroEquipo", urlPatterns = {"/registroEquipo"})
public class registroEquipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       e.setSerial(Integer.parseInt(request.getParameter("serial")));
       e.setNumerolinea(Long.parseLong(request.getParameter("numeroLinea")));
       e.setMarca(request.getParameter("marca"));
       e.setDescripcion(request.getParameter("descri"));
       
       String mensaje =eq.crearEquipo(e);
